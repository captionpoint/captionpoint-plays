...
def format_file(input_path, output_path):
    ...
    try:
        ...
        if "template: title" in first_line:
            ...
            # If no title template, treat as normal stream (or handle appropriately)
            pass
...
def add_single_slide(slides_list, speaker, lines, is_song, include_header):
    ...
    if is_song:
        slide_parts.append("template: song")
...
if __name__ == "__main__":
    format_file('MY-FAIR-LADY-scratch.md', 'MY-FAIR-LADY.md')